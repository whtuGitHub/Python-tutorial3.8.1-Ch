...
- [3. Python的非正式介绍 (An Informal Introduction to Python)](./documents/chap3/3.Python的非正式介绍-An_Informal_Introduction_to_Python.md)
  
    - [3.1. 把Python当作一个计算器 (Using Python as a Calculator)](./documents/chap3/3.Python的非正式介绍-An_Informal_Introduction_to_Python.md)
        - [3.1.1. 数值 (Numbers)](./documents/chap3/3.Python的非正式介绍-An_Informal_Introduction_to_Python.md)
        - 3.1.2. 字符串 (Strings)
        - 3.1.3. 列表 (Lists)
